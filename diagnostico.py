...
PALABRAS_EXCLUIDAS = [
    ...
    r"\btablero\b",r"\bbrasil\b",r"\bmicrob[uú]s\b",r"\bBol[ií]var\b",r"\bdiscoteca\b",r"\btren\b",r"\bamazonas\b",r"\bamazon[ií]a\b",
    r"\boso\b"
]
...
PALABRAS_URGENTES = [
    ...
    r"\bcorredor humanitario\b", r"\bmilitar[es]\b", r"\bmovilizaci[oó]n\b"
]
